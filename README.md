[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_matrix/raw/main/dist/nv_matrix_v5.7.0.pyz)
...
Download the latest release [nv_matrix_v5.7.0.pyz](https://github.com/peter88213/nv_matrix/raw/main/dist/nv_matrix_v5.7.0.pyz)

- Launch *nv_matrix_v5.7.0.pyz* by double-clicking (Windows desktop),
- or execute `python nv_matrix_v5.7.0.pyz` (Windows), resp. `python3 nv_matrix_v5.7.0.pyz` (Linux) on the command line.
...
The package is also available in zip format: [nv_matrix_v5.7.0.zip](https://github.com/peter88213/nv_matrix/raw/main/dist/nv_matrix_v5.7.0.zip)

- Extract the *nv_matrix_v5.7.0* folder from the downloaded zipfile "nv_matrix_v5.7.0.zip".
